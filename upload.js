...
function searchPhoto() {
  ...
  var apigClient = apigClientFactory.newClient({
    apiKey: 'dvsEgztNHyQSiO6ZwVH96w7axUFdfS95fFXYfeb2'
  });
  ...
  var params = {
    q: image_message,
    'x-api-key': 'dvsEgztNHyQSiO6ZwVH96w7axUFdfS95fFXYfeb2'
  };
...
function uploadPhoto() {
  ...
  let config = {
   ...
   url = 'https://dz0s0qygw5.execute-api.us-west-2.amazonaws.com/test1/upload/photosforsearch1/' + file.name
